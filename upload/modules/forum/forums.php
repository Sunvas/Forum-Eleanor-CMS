...
class ForumForums extends Forum
{
	public static
		$rights=array(#Права по глобальному умолчанию
			...
			#Опросы
			'createvoting'=>true,#Позволить создавать опросы
			'editvoting'=>true,#Позволить править опросы
			'vote'=>true,#Позволить голосовать в опросах
		),
		$moder=array(#Права модератора глобальному по умолчанию
			...
			'voting'=>false,#Позволить модерировать опросы
		);
